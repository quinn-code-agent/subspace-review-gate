...
4. Open the artifact in Human Review. For a remote reviewer, use the patched Human Review fork through an authenticated or Tailnet-only endpoint. Confirm a submitted feedback batch reaches `human-review poll` before claiming external review works.
